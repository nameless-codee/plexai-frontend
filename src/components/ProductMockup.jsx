	...
	return (
		<div className="relative mx-auto mt-8 sm:mt-10 w-full max-w-5xl">
			...
			<motion.div
				variants={floating}
				animate="animate"
				className="hidden lg:flex flex-col gap-1.5 absolute -top-5 -left-4 z-20 bg-white border border-black/10 shadow-xl rounded-xl p-3 w-64 text-left"
			>
				...
				<div className="pt-1.5 border-t border-black/5 grid grid-cols-3 text-center">
					<div>
			...
			<motion.div
				variants={floating}
				animate="animate"
				className="hidden lg:flex items-center gap-2.5 absolute -bottom-4 -right-4 z-20 bg-white border border-black/10 shadow-xl rounded-xl px-3 py-2"
			>
				...
				<div className="text-left">
					...
					<p className="text-[10px] text-[#6B7280]">{t.mockup.gpsVerified}</p>
				</div>
			</motion.div>
			...
			<div className="overflow-hidden rounded-2xl border border-black/10 bg-white shadow-xl">
				{/* Top Control Bar */}
				<div className="h-10 border-b border-black/5 bg-[#F8F8F5]/70 px-4 flex items-center justify-between">
					<div className="flex items-center gap-1.5">
						<div className="h-2.5 w-2.5 rounded-full bg-black/15" />
						<div className="h-2.5 w-2.5 rounded-full bg-black/15" />
						<div className="h-2.5 w-2.5 rounded-full bg-black/15" />
					</div>
					<div className="flex items-center gap-2 bg-white border border-black/10 rounded-md px-2.5 py-1 text-[11px] text-[#6B7280] w-60 sm:w-72">
				...
				<div className="p-4 sm:p-5 grid grid-cols-1 lg:grid-cols-3 gap-4">
					<div className="lg:col-span-2 flex flex-col gap-3">
						<div className="rounded-xl border border-black/10 p-3.5 bg-[#F8F8F5]/30">
							...
							<div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 mt-2.5">
								<div className="p-2 rounded-lg bg-white border border-black/5">
									...
									<p className="text-sm font-bold text-[#111111]">4.8%</p>
								</div>
								<div className="p-2 rounded-lg bg-white border border-black/5">
									<span className="text-[10px] text-[#6B7280]">
										{t.mockup.cashFlow}
									</span>
									<p className="text-sm font-bold text-emerald-600">+$310/mo</p>
								</div>
								<div className="p-2 rounded-lg bg-white border border-black/5">
									<span className="text-[10px] text-[#6B7280]">
										{t.mockup.compGap}
								...
								<div className="p-2 rounded-lg bg-white border border-black/5">
									...
									<p className="text-sm font-bold text-[#111111]">$18,450</p>
								</div>
							</div>
						</div>

						{/* Cadastre & Development block */}
						<div className="rounded-xl border border-black/10 p-3 bg-white flex flex-col gap-2">
							<div className="flex items-center justify-between">
							...
							<div className="p-2.5 bg-[#F8F8F5] rounded-lg border border-black/5 text-xs flex items-center justify-between">
								<div>
								...
								<span className="text-[10px] font-bold bg-white px-2 py-0.5 rounded border border-black/10 text-emerald-700">
					...
					<div className="rounded-xl border border-black/10 p-3 bg-[#F8F8F5]/50 flex flex-col justify-between gap-2">
						...
						<div className="divide-y divide-black/5 flex flex-col">
							{[
								...
								>
									<div>
										<p className="font-semibold text-[#111111] text-[11px]">
											{item.address}
										</p>
										<p className="text-[10px] text-[#6B7280]">{item.area}</p>
									</div>
									<div className="text-right">
										<span className="font-bold text-[#635BFF] text-xs">
											Score {item.score}
										</span>
										<p className="text-[9px] text-emerald-600">{item.flag}</p>
									</div>
								</div>
							))}
						</div>
